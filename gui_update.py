...
class MainWindow(QMainWindow):
    ...
    def setup_chart(self, widget, title, y_range=(-1.5, 1.5)):
        ...
        ax.set_ylim(y_range)
        ax.grid(True)
        line, = ax.plot(self.time_data, [0] * self.data_points)
